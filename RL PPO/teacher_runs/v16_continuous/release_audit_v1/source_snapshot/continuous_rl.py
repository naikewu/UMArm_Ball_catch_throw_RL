...
def pilot(args):
    ...
    if args.release_audit:
        variants = {"v15_bc":None,"continuous":ContinuousConfig(),
            "aligned_kinematics":ContinuousConfig(align_release_clock=True,release_azimuth_bias_deg=0.),
            "ball_fit16":ContinuousConfig(release_ball_frames=16,align_release_clock=True,release_azimuth_bias_deg=0.),
