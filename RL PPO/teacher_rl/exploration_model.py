"""V18 ten-action residual PPO; checkpoint-incompatible with V16/V17."""
...
from .exploration_env import ACTOR_DIM, OBS_DIM, RESIDUAL_SIZE, SCHEMA
...
def load_policy(path, source_hash, anchor_sha256):
    ...
    if (payload.get("schema") != SCHEMA or payload.get("source_hash") != source_hash or
        ...
        raise ValueError("V18 checkpoint source/schema/BC anchor mismatch")
